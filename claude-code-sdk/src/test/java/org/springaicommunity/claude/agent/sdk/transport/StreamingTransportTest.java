...
class StreamingTransportTest {
	...
	class TransportStateTests {
		...
		void notRunningInitially() {
			StreamingTransport transport = new StreamingTransport(tempDir.toString());
		...
		void customTimeout() {
			...
			StreamingTransport transport = new StreamingTransport(tempDir.toString(), customTimeout);
